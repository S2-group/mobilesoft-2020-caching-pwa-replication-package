...
export default class AltOriginManager {
    ...
    static async removeDuplicatedAltOriginSubscription(proxyFrameHosts) {
        ...
        var oneSignalComProxyFrameHost = subscribedProxyFrameHosts.find(proxyFrameHost => contains(proxyFrameHost.url.host, hostToCheck));
     ...
     * possible URLs.
     */
    static getCanonicalSubscriptionUrls(config, buildEnv = SdkEnvironment.getBuildEnv()) {
        let urls = [];
